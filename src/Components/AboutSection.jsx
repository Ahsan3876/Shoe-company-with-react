...
export default function AboutSection() {
  return (
    <>
      <section
        id="about"
        className="section-container mt-32 flex flex-col md:flex-row md:space-x-12 scroll-mt-28"
      >
        <h2 className="text-3xl my-6 text-center font-bold md:hidden">
          About Us!
        </h2>
        <div className="bg-[url('./images/background-image.png')] bg-no-repeat md:w-full self-center">
          <img src="./images/about-shoe-company 1 (1).png" alt="legs" />
        </div>
